...
%%% 说明本文的适应度赋值部分
% 适应度赋值通常需要分为两个步骤，首先需要根据算子的应用评价算子的影响，其次根据前一步中算子的影响为算子确定适应度值。
The credit assignment is to estimate the quality of operators based on the impact of their most recent applications

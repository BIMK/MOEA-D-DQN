...
%%% 实验研究
% 为了证明算法MOEA/D-DDQN的有效性，我们在ZDT，WFG，DTLZ，LSMOP数据集进行了测试，并且和MOEA/D-DE,MOEA/D-DRA,MOEA/D-FRRMAB,MOEA/D-IR比较了结果。
To prove the effectivenness of MOEA/D-DDQN, we test it on ZDT, WFG, DTLZ datasets, and compare the results with those obtained by MOEA/D-DE, MOEA/D-DRA, MOEA/D-FRRMAB, MOEA/D-IR.
...
% 算法的参数设置如下
The parameter settings of MOEA/D-DDQN are as follows.
\begin{enumerate}
  \item
\end{enumerate}

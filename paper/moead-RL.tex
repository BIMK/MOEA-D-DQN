...
\begin{enumerate}
  ...
  \item MOEA/D-M2M mutation
        \begin{align}
           & v^{i}_{k} = x^{i}_{k} + rm \cdot (ub(k)-lb(k))                                                     \\

...
In order to avoid the operator probability is too small to be selected, PM designs a minimum probability, $P_{min} > 0$, for exploring currently underperforming operator.
